<template>
  <view class="container">
    ...
    <view class="detail-desc">
      ...
      <u-parse :content="product.detail" class-name="rich-img" />
    </view>
    ...
    <view class="page-bottom">
      ...
      <view :class="{active: product.favorite}" class="p-b-btn" @click="likeIt">
    ...
    <!-- 规格-模态层弹窗 -->
    <view :class="specClass" class="popup spec" @touchmove.stop.prevent="stopPrevent" @click="closeSpec">
      <!-- 遮罩层 -->
      <view class="mask" />
      <view class="layer attr-content">
        ...
        <scroll-view scroll-y="true" style="max-height: 70vh;" @click.stop="stopPrevent">
          ...
          <view style="height: 70upx; margin-bottom: 100upx; margin-top: 15upx; position: relative;">
            <uni-number-box :min="1" :value="buyNum" :is-min="buyNum===1" class="step" @eventChange="numberChange" />
          </view>
