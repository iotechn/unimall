<template>
  <view class="content">
    <view class="search-box">
      ...
      <mSearch v-model="keyword" :mode="2" :placeholder="defaultKeyword" class="mSearch-input-box" button="inside" @search="doSearch(false)" @input="inputChange" @confirm="doSearch(false)" />
    </view>
