<template>
  <view class="content">
    <scroll-view scroll-y class="left-aside">
      <view v-for="item in flist" :key="item.id" :class="{active: item.id === currentId}" class="f-item b-b" @click="tabtap(item)">
        {{ item.title }}
      </view>
    </scroll-view>
    <scroll-view :scroll-top="tabScrollTop" scroll-with-animation scroll-y class="right-aside">
      <view class="s-list">
