  ...
  <view class="container">
    <view class="user-section">
      ...
      <view class="user-info-box">
        <view class="portrait-box">
          <image :src="userInfo.avatarUrl || '/static/missing-face.png'" class="portrait" />
        </view>
        <view class="info-box">
    ...
    >
      ...
      <view class="order-section">
        <view :hover-stay-time="50" class="order-item" hover-class="common-hover" @click="navTo('/pages/order/list?state=0')">
          <text class="yticon icon-shouye" />
          <text>全部订单</text>
        </view>
        <view :hover-stay-time="50" class="order-item" hover-class="common-hover" @click="navTo('/pages/order/list?state=10')">
          <text class="yticon icon-daifukuan" />
          <text>待付款</text>
        </view>
        <view :hover-stay-time="50" class="order-item" hover-class="common-hover" @click="navTo('/pages/order/list?state=30')">
          <text class="yticon icon-yishouhuo" />
          <text>待收货</text>
        </view>
        <view :hover-stay-time="50" class="order-item" hover-class="common-hover" @click="navTo('/pages/order/list?state=60')">
      ...
      <view class="history-section icon">
        ...
        <!-- #ifdef MP-WEIXIN -->
        <list-cell :open-type="'contact'" icon="icon-huifu" icon-color="#e07472" title="在线客服" />
        <!-- #endif -->
