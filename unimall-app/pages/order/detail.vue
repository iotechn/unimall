  ...
  <view>
    ...
    <view v-if="orderDetail.province" class="address-section">
      <view class="order-content">
        ...
        <view class="cen">
          ...
          <text class="address">
            {{ orderDetail.province }} {{ orderDetail.city }} {{ orderDetail.county }} {{ orderDetail.address }}
          </text>
        </view>
      ...
      <view v-for="(item, index) in orderDetail.skuList" :key="index" class="g-item">
        ...
        <view class="right">
          ...
          <view class="price-box">
            <text class="price">
              <text v-if="item.price < item.originalPrice" style="text-decoration:line-through">
                ￥{{ item.originalPrice | priceFormat }}
              </text><text>￥{{ item.price | priceFormat }}</text>
            </text>
            <text class="number">
              x {{ item.num }}
            </text>
    ...
    <view class="yt-list">
      ...
      <view class="yt-list-cell b-b">
        ...
        <text class="cell-tip">
          {{ orderDetail.status | statusFilter }}
        </text>
      </view>
      ...
      <view v-if="orderDetail.status === 30" class="yt-list-cell b-b">
        ...
        <text class="cell-tip red">
          {{ confirmTime ? confirmTime : 'loading' }}
        </text>
      </view>
      <view class="yt-list-cell b-b">
        <text class="cell-tit clamp">
        ...
        <text class="cell-tip">
          ￥{{ orderDetail.skuOriginalTotalPrice | priceFormat }}
        </text>
      </view>
      <view v-if="orderDetail.skuOriginalTotalPrice > orderDetail.skuTotalPrice" class="yt-list-cell b-b">
        ...
        <text class="cell-tip red">
          -￥{{ (orderDetail.skuOriginalTotalPrice - orderDetail.skuTotalPrice) | priceFormat }}
        </text>
      </view>
      ...
      <view v-if="orderDetail.payChannel" class="yt-list-cell b-b">
        ...
        <text class="cell-tip">
          {{ orderDetail.payChannel | payChannelFilter }}
        </text>
      </view>
      ...
      <view class="yt-list-cell desc-cell">
        ...
        <input v-model="orderDetail.mono" class="desc" type="text" disabled="true">
      </view>
    </view>
  </view>
</template>
...
export default {
  ...
  methods: {
    ...
    secondsToDays(sec) {
      ...
      // 对一小时取模
      const hours = parseInt((sec % (60 * 60 * 24)) / (60 * 60))
      // 对一分钟取模
      const minutes = parseInt((sec % (60 * 60 * 24)) % (60 * 60) / 60)
      // 剩下的为秒钟
      const seconds = parseInt((sec % (60 * 60 * 24)) % (60 * 60) % 60)
      let res = ''
      res += (days ? (days + '天') : '')
      res += (hours ? (hours + '小时') : '')
