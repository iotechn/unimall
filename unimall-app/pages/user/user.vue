			...
			<view class="order-section">
			 ...
			 <view class="history-section icon">
				...
				<scroll-view v-if="footprintList.length > 0" scroll-x class="h-list">
					<image v-for="(item, index ) in footprintList" :key="index" @longpress="deleteFootprint(item)" @click="navTo('/pages/product/product?id=' + item.spuId)" :src="item.spuImg" mode="aspectFill"></image>
				</scroll-view>
