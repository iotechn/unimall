<template>
  <div class="dashboard-editor-container">
      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="handleSetLineChartData('messages')">
          ...
          <div class="card-panel-description">
            ...
            <count-to :start-val="0" :end-val="activeUserCount" :duration="3000" class="card-panel-num"/>
          </div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
    ...
    <div id="userChart" class="chart" style="height: 400px"></div>
  </div>
</template>
  ...
  export default {
    ...
    created() {
      info().then(response => {
        ...
        //转换
        let dayMap = response.data.data.dayMap
