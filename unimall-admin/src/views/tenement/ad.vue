<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-button v-permission="['admin:ad:create']" class="filter-item" type="primary" icon="el-icon-edit"
    ...
    <el-table v-loading="listLoading" :data="list" size="small" element-loading-text="正在查询中。。。" border fit
      ...
      <el-table-column align="center" label="操作" width="200" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button v-permission="['admin:ad:update']" type="primary" size="mini"
                     @click="handleUpdate(scope.row)">编辑
          </el-button>
          <el-button v-permission="['admin:ad:delete']" type="danger" size="mini"
