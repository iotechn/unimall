...
public interface AdminCouponService {
    ...
    public Boolean addCoupon(@NotNull @HttpParam(name = "adminId", type = HttpParamType.ADMIN_ID, description = "管理员ID") Long adminId,
                             ...
                             @NotNull @HttpParam(name = "description", type = HttpParamType.COMMON, description = "优惠卷描述") String description,
                             ...
                             @NotNull @HttpParam(name = "categoryId", type = HttpParamType.COMMON, description = "优惠类别") Long categoryId,
    ...
    public Boolean deleteCoupon(@NotNull @HttpParam(name = "adminId", type = HttpParamType.ADMIN_ID, description = "管理员ID") Long adminId,
    ...
    public Boolean updateCoupon(@NotNull @HttpParam(name = "adminId", type = HttpParamType.ADMIN_ID, description = "管理员ID") Long adminId,
